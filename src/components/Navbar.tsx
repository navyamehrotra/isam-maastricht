    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          {/* Miniature Ashoka Chakra */}
          <div className="relative w-9 h-9 flex items-center justify-center">
            <div className="absolute inset-0 rounded-full border-2 border-primary/60 animate-[mandala-spin_8s_linear_infinite]" />
            <div className="w-5 h-5 rounded-full bg-primary/20 border border-primary/60 flex items-center justify-center">
